...
import jdk.internal.org.objectweb.asm.CurrentFrame;
...
public class Listing0601 {
    ...
    private static void groupImperatively() {
        ...
        for (Transaction item : transactions) {
            ...
            List<Transaction> tmpTransactions = transactionsByCurrencies.get(tmpCurrency);
            if (tmpTransactions == null) {
                tmpTransactions = new ArrayList();
                transactionsByCurrencies.put(tmpCurrency, tmpTransactions);
            }
